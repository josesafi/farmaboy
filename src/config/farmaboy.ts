...
export const farmaboyConfig = {
  ...
  contact: {
    phone: "+57 322 386 3977",
    phoneClean: "573223863977",
    phoneDisplay: "+57 322 386 3977",
    whatsapp: "+57 322 386 3977",
    whatsappClean: "573223863977",
    whatsappDisplay: "+57 322 386 3977",
    emailGeneral: "info@farmaboy.com",
    emailB2B: "info@farmaboy.com",
    address: "Avenida Circunvalar No. 10 - 256, Duitama, Boyacá, Colombia",
    city: "Duitama, Boyacá",
  ...
  rutFiscal: {
    ...
    representanteLegal: "Registrada ante Cámara de Comercio",
    cedulaRepresentante: "",
    direccionPrincipal: "Avenida Circunvalar No. 10 - 256 (AV CRV 10 256)",
    ciudad: "Duitama",
    departamento: "Boyacá",
    codigoMunicipioDian: "15238",
    correoElectronico: "info@farmaboy.com",
    telefonoContacto: "+57 322 386 3977",
    seccionalDian: "Sogamoso (Boyacá)",
    actividadesCIIU: [
      {
        codigo: "4645",
