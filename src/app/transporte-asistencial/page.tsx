          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-primary mb-4">
                {inserboyConfig?.sectionOxygenTitle || 'Suministro de Ox�geno Medicinal y Equipos Especializados'}
              </h2>
        ...
        <section className="py-16 bg-slate-50 border-t border-slate-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-10">
              ...
              <p className="text-slate-600 mt-2">Encuentra los insumos m�dicos que necesitas.</p>
            </div>
