      ...
      {filtered.length === 0 ? (
        <div className="bg-white rounded-3xl p-12 text-center border border-slate-200/90 shadow-sm">
          ...
          <h3 className="text-base font-black text-slate-900">
            No tienes compras recurrentes programadas
          </h3>
          <p className="text-xs text-slate-500 mt-1 max-w-md mx-auto">
            Programa el despacho periódico de tus tratamientos médicos permanentes en Boyacá para nunca quedarte sin ellos.
          </p>
          <Link
            href="/productos"
